          ...
          <div className="grid items-center gap-16 lg:grid-cols-2 lg:gap-8">
            ...
            <div className="flex flex-col items-center space-y-8 text-center lg:items-start lg:text-start">
              ...
              <div className="flex w-full flex-col justify-center gap-4 sm:flex-row lg:justify-start">
                <Link
                  href={URLS.courses}
                  className="inline-flex h-14 items-center justify-center gap-2 rounded-xl bg-primary px-8 text-base font-bold text-primary-foreground shadow-lg transition-all hover:scale-105 hover:bg-primary/90 hover:shadow-primary/25 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
                >
                  ابدأ التعلم الآن
                ...
                <Link
                  href={URLS.packages}
                  className="inline-flex h-14 items-center justify-center gap-2 rounded-xl border-2 border-border bg-transparent px-8 text-base font-bold text-foreground transition-all hover:border-primary/50 hover:bg-primary/5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
                >
                  استكشف الباقات
                </Link>
              </div>
            ...
            <div className="relative mx-auto w-full max-w-125 lg:max-w-none">
              <div className="relative w-full rounded-[2rem] border border-border bg-card p-2 shadow-2xl">
                ...
                {/* Floating Elements */}
                <div className="absolute -right-6 -top-6 z-20 rounded-2xl bg-primary p-4 shadow-xl transition-transform hover:scale-110 motion-safe:animate-bounce">
                  <Code2 className="size-8 text-primary-foreground" />
                </div>
                <div className="absolute -bottom-6 -left-6 z-20 rounded-2xl border border-border bg-secondary p-4 shadow-xl transition-transform hover:scale-110 motion-safe:animate-bounce" style={{ animationDelay: "150ms" }}>
                  <Terminal className="size-8 text-primary" />
                </div>
                <div className="absolute -bottom-10 right-12 z-20 rounded-full border border-border bg-background p-3 shadow-xl motion-safe:animate-pulse">
                  <Rocket className="size-6 text-destructive" />
                </div>
                ...
                <div dir="ltr" className="relative min-h-100 w-full flex-col overflow-hidden rounded-[1.5rem] bg-secondary/50">
                  ...
                  {/* IDE Content */}
                  <div  className="flex-1 p-6 font-mono text-sm leading-relaxed text-foreground/90 sm:text-base">
                    ...
                    <div className="mt-2 flex gap-3 ps-6">
                      <span className="text-primary">return</span> 
                      <span>{"{"}</span>
                    </div>
                    
                    <div className="mt-2 flex gap-3 ps-12">
                      <span>success:</span> 
